...
const PROMPT = `Сгенерируй ровно 10 уникальных фитнес-вопросов на проверку знаний.

Верни СТРОГО валидный JSON без markdown — только JSON-объект.
...
Требования:
- Ровно 10 вопросов, в каждом ровно 5 вариантов, РОВНО один правильный.
- Сценарии варьируй: Питание, Техника упражнений, Восстановление, ИМТ, Ожирение, Кардио, Силовая.
- Весь текст на русском.
- Научно корректно (дефицит/профицит калорий, белок 1.6–2 г/кг, ИМТ >30 ожирение, сон 7–9 ч, прогрессивная перегрузка, форма приседа/жима/тяги).
- Не повторяй вопросы.`;
